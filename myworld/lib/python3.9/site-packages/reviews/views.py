...
def add_form(request, content_type_id, content_id, template_name="final/review_form.html"):
...
def reedit(request, template_name="final/review_form.html"):
...
def preview(request, template_name="final/review_preview.html"):
...
def thank_you(request, template_name="final/thank_you.html"):
...
def already_rated(request, template_name="final/already_rated.html"):
